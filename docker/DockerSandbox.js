...
*/
var DockerSandbox = function(timeout_value,path,folder,vm_name,compiler_name,file_name,code,webextpath,output_command,languageName,e_arguments,stdin_data) {
...
DockerSandbox.prototype.prepare = function(success) {
    ...
    var sandbox = this;
    debugger;
    exec("mkdir " + this.path + this.folder + " && cp -r " + this.path + "/Payload/* " + this.webextpath + " " + this.path + this.folder + " && chmod 777 " + this.path + this.folder, function(st) {
